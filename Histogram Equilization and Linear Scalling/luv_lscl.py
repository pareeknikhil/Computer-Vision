...
minimum = min(luvImage[H1: H2+1, W1: W2+1, 0].flatten())
maximum = max(luvImage[H1: H2+1, W1: W2+1, 0].flatten())

value = 255.0/(maximum-minimum)
luvImageWindow1 =tmp2[H1: H2+1, W1: W2+1, 0] 

luvImageWindow2 = (luvImageWindow1 - minimum) * float(value) + 0.0
luvImageWindow2 = np.round(luvImageWindow2).astype(int)
