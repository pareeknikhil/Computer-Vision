...
minimum = min(xyzImage[H1: H2+1, W1: W2+1, 1].flatten())
maximum = max(xyzImage[H1: H2+1, W1: W2+1, 1].flatten())

value = 255.0/(maximum-minimum)
xyzImageWindow1 =tmp2[H1: H2+1, W1: W2+1, 1] 

xyzImageWindow2 = (xyzImageWindow1 - minimum) * float(value) + 0.0
xyzImageWindow2 = np.round(xyzImageWindow2).astype(int)
